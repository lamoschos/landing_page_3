  ...
  return (
    <div className='min-h-screen flex flex-col text-white'>
      <main className="container mx-auto px-6 pt-16 flex-1 text-center">
        <h2 className="text-2xl md:text-4xl lg:text-6xl uppercase">Φθυνή ~ Γρήγορη ~ Ασφαλές</h2>
				<h1 className="text-3xl md:text-6xl lg:text-8xl uppercase font-black mb-8">Μετακόμιση</h1>
